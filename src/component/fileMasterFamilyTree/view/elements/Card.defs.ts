// src/view/elements/Card.defs.ts
import { CardDimensions } from '../../types';

export default function setupCardSvgDefs(
  svg: SVGSVGElement,
...
export function updateCardSvgDefs(
  svg: SVGSVGElement,
  card_dim: CardDimensions
): void {
  if (svg.querySelector('defs#f3CardDef')) {
    const defsElement = svg.querySelector('defs#f3CardDef');
    if (defsElement) {
      defsElement.remove();
    }
  }
