// src/view/elements/Card.icons.ts
...
export function userEditIcon(): string {
  return `
...
export function userPlusIcon(): string {
  return `
...
export function userPlusCloseIcon(): string {
  return `
...
export function pencilOffIcon(): string {
  return `
...
export function historyBackIcon(): string {
  return `
...
export function historyForwardIcon(): string {
  return `
...
export function miniTreeIcon(): string {
  return `
...
export function userSvgIcon(): string {
  return svgWrapper(userIcon());
}
export function userEditSvgIcon(): string {
  return svgWrapper(userEditIcon());
}
export function userPlusSvgIcon(): string {
  return svgWrapper(userPlusIcon());
}
export function userPlusCloseSvgIcon(): string {
  return svgWrapper(userPlusCloseIcon());
}
export function plusSvgIcon(): string {
  return svgWrapper(plusIcon());
}
export function pencilSvgIcon(): string {
  return svgWrapper(pencilIcon());
}
export function pencilOffSvgIcon(): string {
  return svgWrapper(pencilOffIcon());
}
export function trashSvgIcon(): string {
  return svgWrapper(trashIcon());
}
export function historyBackSvgIcon(): string {
  return svgWrapper(historyBackIcon());
}
export function historyForwardSvgIcon(): string {
  return svgWrapper(historyForwardIcon());
}
export function personSvgIcon(): string {
  return svgWrapper(personIcon(), '0 0 512 512');
}
export function miniTreeSvgIcon(): string {
  return svgWrapper(miniTreeIcon(), '0 0 72 25');
}

function svgWrapper(icon: string, viewBox: string = '0 0 24 24'): string {
