...
import { ContactNotesTabContentProps } from '../../../interface/note';
...
const NotesTabContent: React.FC<ContactNotesTabContentProps> = ({
  contactId,
  orderBy,
  order,
}) => {
  ...
  const columns: TableColumns[] = [
    ...
    },
    {
      ...
      cellRenderer: params => {
        ...
        const toLink = `/editnote?noteId=${noteId}&route=/editContact/${contactId}`;
